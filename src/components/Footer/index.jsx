...
const Footer = (props) => {
  ...
  const [isEnglishSelected, setEnglishSelected] = useState(false);
  const [isArabicSelected, setArabicSelected] = useState(false);
  ...
  <Button className={`bg-blue-A200 cursor-pointer font-inter leading-[normal] min-w-[80px] py-2 text-center text-sm text-white-A700 ${isEnglishSelected ? 'bg-blue-A400' : ''}`} onClick={handleEnglishClick}>
    English
  </Button>
  <Button className={`cursor-pointer ${isArabicSelected ? 'bg-blue-A400' : ''}`} onClick={handleArabicClick}>
    <Text className="text-blue_gray-700 text-sm w-auto" size="txtInterRegular14">
      Arabic
    </Text>
  </Button>
  <Button className={`cursor-pointer ${isFrenchSelected ? 'bg-blue-A400' : ''}`} onClick={handleFrenchClick}>
    <Text className="text-blue_gray-700 text-sm w-auto" size="txtInterRegular14">
      French
    </Text>
  </Button>
