...
import MyAccountOneColumnhotfood from "components/MyAccountOneColumnhotfood";

const MyAccountOnePage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-roboto items-center justify-start mx-auto w-full">
        <MyAccountOneColumnhotfood className="flex flex-col items-center justify-start w-full" />
        <Img
...
export default MyAccountOnePage;
