...
import MyOrdersOneColumnrectangletwentyfour from "components/MyOrdersOneColumnrectangletwentyfour";

const MyOrdersOnePage = () => {
  return (
    <>
          ...
          <div className="flex md:flex-1 flex-col items-center justify-start md:mt-0 mt-[58px] w-[79%] md:w-full">
            ...
            >
              {new Array(3).fill({}).map((props, index) => (
                <React.Fragment
                  key={`MyOrdersOneColumnrectangletwentyfour${index}`}
                >
                  <MyOrdersOneColumnrectangletwentyfour
...
export default MyOrdersOnePage;
