          ...
          {/* <div className="absolute h-[1024px] inset-[0] justify-center m-auto w-full"> */}
            ...
            <div className="absolute flex flex-col md:h-auto h-max inset-y-[0] items-center justify-start my-auto right-[14%] w-auto mt-[200px] sm:ml-[30px]">
              <div className="flex flex-col items-start justify-start w-full">
                ...
                />
                <LoginColumn
                  className="flex flex-col h-[58px] md:h-auto items-start justify-start mt-[15px] w-[404px] sm:w-full"
                ...
                <div className="h-[35px] md:h-[52px] mt-5 pb-[3px] relative w-full">
                  ...
                  >
                    <button className="flex items-center justify-center">
                      <Text size="txtPoppinsBold13" className="md:mt-[10px] sm:mb-[30px]">Signup</Text>
                    </button>
                  </a>
                </div>
